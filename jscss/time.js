function showTime() { 
	...
	var startDate = new Date(2018, 9, 24);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear YuanHongLin:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----阮麟   2018-12-04</c>"; 
